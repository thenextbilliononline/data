...
plot <- ggplot(data = sorted[2:14,], aes(x=Indicator[2:14], y=Estimate[2:14])) + geom_bar(stat="identity", position=position_dodge()) + ggtitle("Coefficients of Poverty Indicators")
