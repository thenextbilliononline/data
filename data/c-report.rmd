...
map <- joinCountryData2Map(df, nameJoinColumn = "Country", joinCode = "ISO3")
...
trainTransformed <- predict(preProcValues, finances)
colnames(finances) <- c("Education", "Hospitals", "Health", "Highways", "Parks", "Police",  "Administration", "Prisons", "Natural.Resources", "Internet", "Smartphone", "Computer", "Public.Welfare", "Debt")
