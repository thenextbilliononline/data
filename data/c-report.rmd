...
training_nn_ph = training_forest$Percent.Below.Poverty.Line
test_nn = test_forest2
test_nn_ph = test_forest$Percent.Below.Poverty.Line
...
modelperf[7,] = list("Train", "GLM", rmse.glm.train, r2.glm.train)
modelperf[8,] = list("Test", "GLM", rmse.glm.test, r2.glm.test)
