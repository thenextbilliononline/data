...
kable(gdp.slice, caption = 'Selected GDP, PPP (constant 2011 international $) Values, 2000-2016', format = "html") %>%
kable_styling(bootstrap_options = c("striped", "hover"), full_width = F, position = "c") %>%
row_spec(row = 0:0, background = "lightgrey") %>%
column_spec(column = 1, bold = T) 
```
...
kable(lit.slice, caption = 'Selected GDP, PPP (constant 2011 international $) Values, 2000-2016', format = "html") %>%
kable_styling(bootstrap_options = c("striped", "hover"), full_width = F, position = "c") %>%
row_spec(row = 0:0, background = "lightgrey") %>%
column_spec(column = 1, bold = T) 
```
